...
public class UserServiceImpl implements UserService {
    ...
    public void addDefaultUser() {
        ...
        User user1 = new User("Ivan","Ivanov",(byte) 25, "ivanov@mail.com", "user","12345",roles1);
        User user2 = new User("Petr","Petrov",(byte) 30, "petrov_admin@mail.com", "admin","admin",roles2);
        save(user1);
        save(user2);
        }
}
